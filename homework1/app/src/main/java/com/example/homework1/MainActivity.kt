...
class MainActivity : AppCompatActivity() {
    ...
    private fun setRandomValueBetweenOneToHundred() {
        ...
        val strrandom = randomValue.toString()
        randomTextView.setText(strrandom)
    ...
    private fun checkAnswerAndShowToast() {
        ...
        if (textView.text.toString() == randomTextView.text.toString())
            Toast.makeText(this, "축하드립니다! 통과하셨습니다", Toast.LENGTH_SHORT).show()
        else
            Toast.makeText(this, "이런, 실패했어요... 다시도전해보세요", Toast.LENGTH_SHORT).show()
        /**
         * Toast 사용 예)
